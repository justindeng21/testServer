...
class CMSAPI extends server_1.Server {
    ...
    defineCMSEndpoints() {
        ...
        this.httpListener.get('/nonce/test', (req, res) => {
            ...
            let html;
            res.setHeader('Content-Security-Policy', `script-src 'self' data: *.betrad.com *.evidon.com *.evidon.com *.crownpeak.com 'nonce-${nonce}'; connect-src data: *.evidon.com *.betrad.com optoutapi.evidonstage.com; style-src 'self'`);

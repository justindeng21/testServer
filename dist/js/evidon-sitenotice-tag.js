(function() {
    ...
    ;
    aH.prototype._triggerTagManagerEvent = function(aM, a3, aO) {
        if (this.tagManagerEventFired) {
            return
        }
        var a2 = (a3) ? this._createListFromItem(a3) : "";
        ...
        if (typeof window.evidon.enableGoogleConsentSupport === "undefined" || window.evidon.enableGoogleConsentSupport) {
            try {
                var aX = ["google-adsense", "doubleclick", "doubleclick-bid-manager-formerly-invite-media", "admeld", "google-adwords", "google-display-network", "admob-google", "adometry", "google-ad-services", "google-mobile-ads", "googleima"];
                var aY = ["google-analytics"];
                var aW = [];
                var aV = [];
                var aT = "denied"
                  , aS = "denied"
                ...
                if (a2 == "all") {
                    ...
                    if (a2) {
                        var a1 = a2.split(",");
                        for (var a0 = 0; a0 < aY.length; a0++) {
                            if (a1.indexOf(aY[a0]) !== -1) {
                                aT = "granted"
                            }
                        }
                        for (var a0 = 0; a0 < aX.length; a0++) {
                            if (a1.indexOf(aX[a0]) !== -1) {
                                aS = "granted"
                            }
                        }
                        for (var a0 = 0; a0 < aX.length; a0++) {
                ...
                if (this.companyId != 1782) {
                    ...
                    aZ("consent", "update", {
                        ad_storage: aS,
                        analytics_storage: aT,
                        ad_user_data: aU,
                        ad_personalization: aR
                    })
                }
            } catch (aQ) {}
        }
    ...
    ;
    aH.prototype.isOCPA = function() {
        return this.regulationId === aC.OCPA
    }
    ;
    aH.prototype.isTDPSA = function() {
        return this.regulationId === aC.TDPSA
    }
    ;
    aH.prototype.isMCDPA = function() {
        return this.regulationId === aC.MCDPA
    }
    ;

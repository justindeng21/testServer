window.evidon.checkConsentTiming = () =>{
    console.log("%c"+"Consent timing:", "font-size: .75rem");
...
window.evidon.logConsent = () => {
    ...
    console.log("%c"+"Consent Default:", "font-size: .75rem");
...
window.evidon.logConsentUpdate = () => {
    setTimeout(()=>{
        const consentTypes = google_tag_data.ics.entries;
        console.log("%c"+"Consent Update:", "font-size: .75rem");
        for(let consentType in consentTypes){
        ...
        console.log("%c"+"Consented Vendors:", "font-size: .5rem");

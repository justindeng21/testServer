...
exports.EvidonStubHelper = void 0;
class EvidonStubHelper {
    static getSiteNoticeTag(nonce) {
        return `
                    ...
                    (function (id) {
                        function append(scriptid, url, async) {
                            ...
                            if (document.currentScript && document.currentScript.nonce) {
                                s.setAttribute("nonce", document.currentScript.nonce);
                            }
                            s.src = url;
                            s.charset = 'utf-8';
                        ...
                        var cdn = '//staging.betrad.com/', rootDomain = getRootDomain(), noticecdn = cdn + 'sitenotice/';
    ...
    static getOmniTag(nonce) {
        return `<script companyid="6914" nonce="${nonce}" src="https://c.evidon.com/previous/sitenotice/dev/dg.js"></script>`;
    }
}
